...
void config_timer_and_match(void){
    ...
    match_cfg.MatchChannel = MATCH_CHANNEL_0; /** Assign match channel 0 to the match configuration structure */
    match_cfg.IntOnMatch = ENABLE; /** Enable the interrupt on match */
    match_cfg.ResetOnMatch = ENABLE; /** Enable the reset on match */
    match_cfg.StopOnMatch = ENABLE; /** Disable the stop on match */
