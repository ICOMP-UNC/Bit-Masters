...
//         {
//             LPC_GPIO0->FIOCLR = MOTOR_NEG_PIN; /* Turn on LED */
//         }
//         else
//         {
//             LPC_GPIO0->FIOSET = MOTOR_NEG_PIN; /* Turn off LED */
//         }
//     }
// }
...
//         if ((LPC_GPIO2->FIOPIN & MOTOR_POS_PIN) && !(close_door)) /* If the motor is on and the door is not closed */
//         {
//             LPC_GPIO0->FIOCLR = MOTOR_POS_PIN; /* Turn off the motor */
